...
<link
    ...
    />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/mySns.css" />
</head>
<body>
<!-- 헤더 파트 시작  css = 9~97-->
      ...
      <div class="info-part">
        <div class="profile-img-wrap">
          ...
          <div class="profile-img-box">
            <img class="profile-img" src="${pageContext.request.contextPath}/assets/img/SNSPage/01.jpeg" />
          </div>
          <!-- 프로필 이미지 wrap 끝 -->
        </div>
        <div class="info-user">
          ...
          <div class="member-cnt">
            <div class="post-cnt-box">
              게시물
              <span class="post-cnt"> 10</span>
            </div>
            <div class="follower-cnt-box">
              팔로워
              <span class="follower-cnt"> 20</span>
            </div>
            <div class="following-cnt-box">
              팔로우
              <span class="following-cnt"> 40</span>
            </div>
          </div>
    ...
    <div class="modal-box">
        ...
        <div class="comment-container">
          ...
          <div class="host-profile">
            ...
            <div class="host-name-box">
              <span class="host-name">meenoi</span>
            </div>
            <!-- 프로필 박스 끝 -->
          </div>
          <!-- @@@@@@ 모달 댓글 영역 @@@@@@ -->
              ...
              <div class="comment-member-info-box">
                <div class="comment-member-info">
                  ...
                  <div class="comment-member-name-wrap">
                    <a href="#" class="comment-member-name">username</a>
                  </div>
                </div>
      ...
      <div id="modal-btn-box-wrap">
        ...
        <div class="modal-follow-btn-box modal-btn-box">
          <button
            type="button"
            class="modal-follow-btn btn-color"
            id="modal-btn"
          >
        ...
        <div class="modal-edit-btn-box modal-btn-box">
          <button type="button" class="modal-edit-btn btn-color" id="modal-btn">
        ...
        <div class="modal-delete-btn-box modal-btn-box">
          <button
            type="button"
            class="modal-delete-btn btn-color"
            id="modal-btn"
          >
        ...
        <div class="modal-report-btn-wrap modal-btn-box">
          <button
            type="button"
            class="modal-report-btn report-btn-color"
            id="modal-btn"
          >
            ...
            <div class="post-part">
              ...
              <div class="post-info">
                <div class="post-name-box">
                  <span class="post-name">게시물 명</span>
                </div>
                <div class="date-like-wrap">
                  <div class="post-date-box">
                    <span class="post-date">2023년 3월 28일</span>
                  </div>
                  <div class="post-like-cnt-box">
                    <span class="heart">♥</span>
                    <span class="like-cnt">#좋아요 개수</span>
                  </div>
                </div>
              </div>
            </div>
