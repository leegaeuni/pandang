...
<html lang="en">
  <head>
    ...
    />
     <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/my_SNS_main.css" />
  </head>
  <body>
    <!-- 헤더 파트 시작  css = 9~97-->
...
<!-- 푸터 시작 css = 822~857 -->
  ...
  ></script>
    <script src="${pageContext.request.contextPath}/assets/js/my_SNS_main.js"></script>
  </body>
</html>
