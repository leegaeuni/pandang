...
<body>
	<input type="hidden" value="${sessionScope.memberNumber}"
		class="j-login-number">
	<div class="all-wrap">
		<!-- #######header####### -->
			...
			<div class="post-box">
				<div class="profile-path">
					<div class="profile-modal-img-box">
						<a href="#" id="modal-img-box"> <img class="profile-modal-img"
					...
					<div class="comment-container">
                      ...
                      display : flex로 변경되게 해주세요  -->
										...
										<div class="s-edit-btn-box">
											<button type="submit" class="s-edit-btn">수정 완료</button>
										</div>
									</div>
									<div class="height-box"></div>
									<div class="comment">
										<span class="comment-content">너무
											마음에 드는 작품이에요~~~~ </span>
										<!--  @@@@@@ 댓글 수정 form 경로처리 @@@@@@ -->
										<form action="" method="post">
                          ...
                          <span class="comment-content">너무 마음에 드는 작품이에요~~~~
							...
							<div class="comment-list">
								...
								<div class="text-wrap">
									...
									<div class="height-box"></div>
									<div class="comment">
										<span class="comment-content">댓글
											늘어나면 영역 늘어나는지 테스트중 </span>
									</div>
								</div>
							</div>
						</div>
						...
						<form action="" method="post" id="comment-form">
							<div class="write-area">
								...
								<label class="comment-input-box"> <textarea
										class="comment-input-area" placeholder="이 창작물에 대한 댓글을 남겨주세요."></textarea>
								</label>
								<!--  @@@@@@@@@ 댓글 작성 공간 끝 @@@@@@@@@@ -->
							</div>
							<div class="submit-btn-box">
								<!-- @@@@@@@@@ 댓글 작성 버튼 @@@@@@@@@@ -->
								<button class="comment-submit-btn" type="submit">댓글 작성
								</button>
								<!-- @@@@@@@@@ 버튼 끝 @@@@@@@@@@ -->
							</div>
						</form>
            ...
            @@@ 모달 픽시드 구매하기 버튼 내 글일시 안 보여야함 @@@ -->
				<div class="post-btn-box" id="buy">
					<div class="modal-buy-btn-wrap btn-wrap-flex">
						...
						</a> <span class="modal-btn-list">구매하기</span>
					</div>
				</div>
				<!--             @@@ 신고하기 영역 끝 @@@
							...
							<c:forEach var="profil" items="${channels}">
								...
								<div class="hot-creater-profil">
									<div class="profil-photo" name="channel_file_system_name">
										<a
											href="${pageContext.request.contextPath}/sns/snsOk.sn?memberNumber=${profil.getMemberNumber()}">
											<img
											src="${pageContext.request.contextPath}/upload/${profil.getChannelFileSystemName()}" />
										</a>
									...
									<div class="profil-info">
										<div class="profil-info-wrap">
											<div class="profil-channel-name" name="channel_name">
												...
												<img
													src="${pageContext.request.contextPath}/assets/img/main/choigosim.jpg" />
											</div>
		...
		<div class="store-content">
			<div class="store-nav">
				...
				<div class="store-nav-wrap tabs">
					<span>판매글 :</span>
					<ul>
						<li class="tab start-tab" data-tab-target="#tab1">판당 pick</li>
						...
						<c:forEach var="store" items="${stores}">
							<div class="store-photo">
								...
								<div class="store-photo-img"
									data-storeNumber="${store.getStoreNumber()}">
									<img
									...
									<div class="store-info">
										<div class="store-info-tap">
											...
											<span> <c:out value="${store.getStoreTitle() }" />
											</span>
											<div class="like-btn">
												<button>
								...
								<div class="store-info-channel">
									<div class="store-info-channel-name">
										<span> <c:out value="${store.getChannelName() }" />
										</span>
									</div>
