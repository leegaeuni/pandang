...
//		int channelNumber = (Integer)req.getSession().getAttribute("channelNumber");		
		...
		int channelNumber = channelDAO.getChannelNumber((Integer)session.getAttribute("memberNumber"));
...
//      생성자 매개변수 : req, 업로드 경로, 최대 크기, 인코딩 방식, 이름 정책
      ...
      if(multipartRequest.getParameter("memberPassword").equals("")) {
    	  memberDAO.mypageEditNoPw(memberVO);
      }else {
