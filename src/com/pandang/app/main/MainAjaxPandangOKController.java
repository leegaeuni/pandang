...
public class MainAjaxPandangOKController implements Execute{
	...
	public void execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		List<MainLikeViewVO> storeList = mainDAO.select(memberNumber);
		Gson gson = new Gson();
		System.out.println("=======================");
		...
		JsonElement json = JsonParser.parseString(gson.toJson(mainDAO.select(memberNumber)));
